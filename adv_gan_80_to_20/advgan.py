...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='AdvGAN for MNIST 80% -> 20%')
    ...
    # load target_model
    f = getattr(target_models, model_name)(1, 8)
    checkpoint_path_f = os.path.join(base,'saved', 'target_models', 'best_%s_mnist.pth.tar'%(model_name))
    ...
    checkpoint_path_G = os.path.join(base,'saved', 'generators', 'bound_%.1f'%(thres), checkpoint_name_G)
